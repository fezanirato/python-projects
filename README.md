...
| 3 | [Análise de Score de Clientes (IA)](./Análise%20de%20Score%20de%Clientes%20%28IA%29) | Projeto de Machine Learning para prever o score de clientes de um banco, classificando-os conforme o perfil e histórico de crédito, utilizando modelos preditivos. | `Python`, `Scikit-learn`, `Pandas`, `NumPy`, `Matplotlib` |
